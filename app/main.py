...
from app.routes import pdp_plp, attributes, concat_rule, category_tree, rejections, ptypes_dump, admin, color_code, rms_manufacturer_brand, magazine
...
app.include_router(rms_manufacturer_brand.router)
